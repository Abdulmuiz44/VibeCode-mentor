          ...
          <div className="mb-12">
            <div className="flex justify-between items-center mb-6">
              ...
              <button
                ...
                className="px-4 py-2 bg-black hover:bg-gray-800 text-white font-medium rounded-lg transition-all border border-gray-700"
              >
                + Add Custom Prompt
              </button>
            </div>
            ...
            {customPrompts.length > 0 ? (
              ...
              <div className="bg-gray-800/50 backdrop-blur-lg rounded-xl border border-gray-700 p-8 text-center mb-8">
                ...
                <button
                  onClick={() => setShowAddModal(true)}
                  className="px-6 py-2 bg-black hover:bg-gray-800 text-white font-medium rounded-lg transition-all border border-gray-700"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {topVibes.map((vibe, index) => (
                <div
                  ...
                  className="bg-gray-800/50 backdrop-blur-lg rounded-xl border border-gray-700 p-6 hover:border-gray-500 transition-all cursor-pointer group"
                >
        ...
        {user && !isPro && (
          <div className="mt-12 bg-gray-800 border border-gray-700 rounded-2xl p-8 text-center">
            ...
            <button
              ...
              className="px-8 py-3 bg-black hover:bg-gray-700 text-white font-semibold rounded-lg transition-all transform hover:scale-105 border border-gray-600"
            >
