...
export default function BlueprintsPage() {
  ...
  const loadBlueprints = useCallback(async () => {
    ...
    try {
      if (user) {
        console.log('Loading blueprints for user:', {
          id: user.id,
          email: user.email,
  ...
  const handleLoad = (save: SavedBlueprint) => {
    // Navigate directly to the blueprint view
    router.push(`/build/${save.id}`);
  };
      ...
      <div className="container mx-auto px-4 py-12 max-w-6xl">
        ...
        <div className="text-center mb-12">
          ...
          <div className="flex items-center justify-center gap-3">
            <p className="text-gray-400 text-lg">
              Your blueprint library • {saves.length} saved {!isPro && `(${FREE_SAVE_LIMIT} max on free)`}
            </p>
          ...
          {!isPro && (
            <div className="mt-6">
              <button
                onClick={() => openUpgradeModal({ source: 'Blueprints Page' })}
        ...
        {saves.length === 0 && (
          <div className="text-center py-20">
            ...
            <h2 className="text-2xl font-semibold text-gray-300 mb-2">No saved blueprints yet</h2>
            <p className="text-gray-500 mb-6">Generate your first blueprint to get started!</p>
            <button
