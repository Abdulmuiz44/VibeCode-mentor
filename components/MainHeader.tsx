    ...
    <header className="border-b border-gray-800 bg-black/50 backdrop-blur-sm sticky top-0 z-40">
      <div className="container mx-auto flex max-w-6xl items-center justify-between px-4 py-4">
        ...
        <nav className="flex items-center gap-2 md:gap-4">
          ...
          <Link
            href="/templates"
            className="flex items-center gap-2 rounded-lg bg-gray-800 px-3 py-2 text-white transition hover:bg-gray-700"
          >
          ...
          <button
            ...
            className="rounded-full bg-gradient-to-r from-purple-600 to-pink-500 px-4 py-2 text-sm font-semibold uppercase tracking-wide text-white transition hover:scale-105"
          >
            Upgrade to Pro
          </button>
          <AuthButton />
